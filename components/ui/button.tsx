...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        // Ensure className prop is correctly applied alongside the generated class names
        className={cn(buttonVariants({ variant, size }), className)} // Correctly merge generated classes and className prop
        ref={ref}
        {...props}
      />
    )
